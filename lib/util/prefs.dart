...
class Defaults {
  ...
  static const double robotWidth = 0.46;
  static const double robotLength = 0.46;
  ...
  static List<String> autoFolders =
      []; // Can't be const or user wont be able to add new folders
  static const bool snapToGuidelines = false;
  static const bool hidePathsOnHover = true;
  static const double defaultMaxVel = 1.5;
  static const double defaultMaxAccel = 1.5;
